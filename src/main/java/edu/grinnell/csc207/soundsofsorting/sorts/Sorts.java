...
public class Sorts {
    ...
    /**
     * mergeSortH : helps with the mergeSort (recursively)
     * @param <T> : a generic type (comparable)
     * @param arr : a potentially smaller version of the array to be broken down and sorted
     * @param hi : a hi "bound" for merge sort (split)
     * @param lo : a lo "bound" for merge sort (split)
     * @param events : the array of sortEvents. to store what happens
     */
    private static <T extends Comparable<? super T>> void mergeSortH(T[] arr, int hi, int lo,
     ...
     * 
     * @param <T> merge should work on generic arrays.
     ...
     * @param events the array of events that happen to the array during sort
     */
    public static <T extends Comparable<? super T>> void 
        merge(T[] arr, int firstHi, int firstLo, int secondHi,
            int secondLo, List<SortEvent<T>> events) {
     ...
     * 
     * @param <T> the array must be comparable generics
     * @param arr the array to sort
     * @return the sort events generated by this sort
     */
    ...
    /**
     * A helper function to actually sort the array recursively.
     * 
     * @param <T> the array must be comparable generics
     * @param arr The array to be sorted
     * @param lo The lower bound of the array
     * @param hi The higher bound of the array
     * @param events The list of events generated by this sort
     */
    ...
    /**
     * Splits the array into two parts, one with values less than the pivot and one
     * with values greater than the pivot.
     * 
     * @param <T> the array must be comparable generics
     * @param arr    the array to sort
     * @param lo     the lower bound of the array
     * @param hi     the higher bound of the array
     * @param events the list of events generated by this sort
     * @return the index value of the pivot spot
     */
     ...
     * Essentially a bubble sort that goes in both directions.
     * 
     * @param <T> the carrier type of the array
     * @param arr the array to sort
     * @return the sort events generated by this sort
    ...
    /**
     * Applies a list of events which are "in order" to an array.
     * 
     * @param <T> the array must be comparable generics
     * @param arr : an array of Ts to be sorted.
     * @param events : the array of sort events to apply to that array.
     */
