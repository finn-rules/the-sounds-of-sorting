...
public class Sorts {
    ...
    /**
     * A helper function to actually merge sort the array recursively.
     * @param <T>
     ...
     */
    private static <T extends Comparable<? super T>> void mergeSortH(T[] arr, int hi, int lo, List<SortEvent<T>> events) {
        int mid = lo + (hi - lo) / 2;
        if(lo < mid) {
         ...
         */
        public static <T extends Comparable<? super T>> void merge(T[] arr, int firstHi, int firstLo, int secondHi, int secondLo, List<SortEvent<T>> events) {
     ...
     * @param events: The list of events generated by this sort
     */
    private static <T extends Comparable<? super T>> void quickSortH(T[] arr, int lo, int hi,  List<SortEvent<T>> events) {
        if (lo < hi && lo >= 0 && hi >= 0) {
     ...
     */
    private static <T extends Comparable<? super T>> int splitValue(T[] arr, int lo, int hi, List<SortEvent<T>> events) {
        T midValue = arr[lo];
        int i = lo - 1;
        int j = hi + 1;
